...
public class MerchTestData {
    public static final MatcherFactory.Matcher<Merch> MERCH_MATCHER = MatcherFactory.usingIgnoringFieldsComparator();
    ...
    public static List<Merch> userList = Arrays.asList(merch1, merch2);
